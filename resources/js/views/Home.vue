    ...
    <div class="main-slider position-relative min-vh-100 d-flex align-items-center">
        <div class="container">
            <div class="col-lg-5 position-absolute top-0 start-0 bottom-0 d-flex align-items-center d-none d-lg-flex">
                <img src="front/build/img/main.png" alt="">
            </div>
            <div class="w-100">
                <div class="row justify-content-end">
                    <div class="col-lg-7">
                        ...
                        <div class="d-flex align-items-center flex-column flex-md-row">
                            <a href="#" class="btn-of rounded-pill px-4 py-3 fw-bold d-flex align-items-center justify-content-center mb-3 mb-md-0">اكتشف قائمة الطعام <img src="front/build/img/arrow-left.svg" alt="" class="ms-3"></a>
                            <a href="#" class="fw-bold ms-0 ms-md-3"><img src="front/build/img/locate.svg" alt="" class="me-3 w-25"> انظــر مـا يتــم تحضيــره</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <div class="feature-icon">
                            <img src="front/build/img/icon-1.svg" alt="">
                        </div>
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <div class="feature-icon">
                            <img src="front/build/img/icon-2.svg" alt="">
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="feature-icon">
                            <img src="front/build/img/icon-3.svg" alt="">
                        </div>
    ...
    <div class="container py-5 food-menu">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="food-box bg-white overflow-hidden">
                    <div class="food-thumbnail">
                        <a href="#"><img src="front/build/img/food-thumbnail.png" alt=""></a>
                    </div>
                    <div class="py-4 px-4 text-center">
                        <h5 class="fw-bold"><a href="#">دايــت بــلان</a></h5>
                        <p class="mb-4">نظام غذائي صحي يساعدك على خســارة الوزن مع المحافظة على أعلى مستويات الطاقة</p>
                        <a href="#">عرض التفاصيل <img src="front/build/img/arrow-left-black.svg" alt="" class="ms-2"></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
        ...
        <div class="row">
            <div class="col d-flex justify-content-center my-4">
                <a href="#" class="btn-of rounded-pill px-4 py-3 fw-bold d-flex align-items-center justify-content-center">اكتشف قائمة الطعام <img src="front/build/img/arrow-left.svg" alt="" class="ms-3"></a>
            </div>
        </div>
    </div>
                    ...
                    <div class="ask-me position-relative pe-5 overflow-hidden">
                        <div class="row py-5 justify-content-between">
                            ...
                            <div class="col-lg-4 d-flex align-items-end justify-content-start justify-content-lg-end mt-4 mt-lg-0 justify-content-center justify-content-md-start">
                                <div>
                                    <a href="#" class="btn-of rounded-pill px-4 py-3 fw-bold d-flex align-items-center justify-content-center">اطلب استشارة <img src="front/build/img/arrow-left.svg" alt="" class="ms-3"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="swiper-img">
                        <a href="#" class="text-center position-relative">
                            <img src="front/build/img/member.png" alt="" class="rounded-4">
        ...
        <div class="container">
                    ...
                    <div class="swiper-b d-flex align-items-center flex-row-reverse justify-content-center justify-content-md-end">
                        <div class="d-flex align-items-center">
                            <div class="swiper-b-next ms-0 ms-md-4">
                                <img src="front/build/img/swiper-right.svg" alt="">
                            </div>
                            <div class="swiper-b-prev ms-2">
                                <img src="front/build/img/swiper-left.svg" alt="">
                            </div>
                        </div>
                        <hr>
                    </div>
            ...
            <div class="row">
                <div class="col d-flex justify-content-center">
                    <a href="#" class="btn-of rounded-pill px-4 py-3 fw-bold d-flex align-items-center justify-content-center">عرض جميع المشاهير <img src="front/build/img/arrow-left.svg" alt="" class="ms-3"></a>
                </div>
            </div>
        </div>
    </div>
