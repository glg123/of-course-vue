@php $titlePage = __('translation.invoices'); @endphp
            ...
            <div class="col-lg-8">
                <div class="bg-white rounded-4 p-2 p-lg-4">
                    <div class="bg-white-blue px-3 py-3 rounded-2 border-right-box mb-4 d-flex align-items-center justify-content-between flex-column flex-lg-row gap-3">
                        <h6 class="fw-bolder mb-0">الفواتير</h6>
                    </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 gap-lg-5">
                                <div class="d-flex flex-wrap gap-3 gap-lg-5">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <h6 class="f12 fw-bold mb-0"><span class="bg-warning text-white px-3 py-1 d-inline-block rounded-pill">معلقة</span></h6>
                                    </div>
                                </div>
                                <a href="#" class="btn bg-white-blue-2 rounded-pill px-4 py-2 fw-bold d-flex align-items-center justify-content-center border-purple text-purple">تحميل</a>
                            </div>
                        </div>
                        <div class="bg-white-blue p-4 rounded-2 box-list">
                            <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-3">
                        ...
                        <div class="bg-white-blue p-4 rounded-2 box-list">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 gap-lg-5">
                                <div class="d-flex flex-wrap gap-3 gap-lg-5">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="f14 text-muted">الحالة</h6>
                                        <h6 class="f12 fw-bold mb-0"><span class="bg-black text-white px-3 py-1 d-inline-block rounded-pill">تم الدفع</span></h6>
                                    </div>
                                </div>
                                <a href="#" class="btn btn-outline-dark rounded-pill px-4 py-2 fw-bold d-flex align-items-center justify-content-center">استرداد</a>
                            </div>
                        </div>
                        <div class="bg-white-blue p-4 rounded-2 box-list">
                            <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-3">
