            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-3">
                        <h1 class="page-main-title">المنطقة </h1>
                    </div>
                    @if (auth()->user()->can('location-add'))
                        <div class="col-12 col-lg-4">
                            <div class="page-card-btn-groub">
                                ...
                                <a type="button"
                                    class="btn disabled btn-light disabled waves-effect waves-light d-flex align-items-center"> <i
                                        class="bx bx-file-blank mx-1"></i> <span>سجل تدقيق</span> </a>
                            </div>
                        </div>
                    @endif
                    <div class="col-12 mt-3">
                        <form action="{{ route('locations.area') }}">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-lg-9">
                                        <div>
                                            ...
                                            <input name="q" class="form-control" placeholder="ابحث عن منطقة">
                                        </div>
                                    </div>
                    ...
                    <div
                        ...
                        <div class="table-title-container">
                            <h3 class="table-title">المناطق</h3>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('locations.area.store') }}" method="POST">
                        @csrf
                        <div class="row align-items-end justify-content-start">

                            <div class="col-lg-6">
                                <div>
                                    <label class="form-label">اسم المنطقة (باللغة العربية)</label>
                            ...
                            <div class="col-lg-6 mt-3">
                                <div>
                                    <label class="form-label">اسم المنطقة (باللغة الإنجليزية)</label>
                                    <input name="name[en]" required class="form-control"
                                        placeholder="اسم المنطقة (باللغة الإنجليزية)">
                                </div>
                            </div>
