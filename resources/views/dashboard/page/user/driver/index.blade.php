...
@section('content')
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-3">
                        <h1 class="page-main-title">السائقين/المناديب </h1>
                    </div>

                    <div class="col-12 col-lg-5">
                        <div class="page-card-btn-groub">
                            @if (auth()->user()->can('manager-driver-add'))
                                <button type="button"
                                    class="btn btn-light waves-effect waves-light d-flex align-items-center"
                                    data-bs-toggle="modal" data-bs-target=".add-new-driver"> <i
                                        class="bx bx-plus-circle mx-1"></i> <span>إضــافة سائق / مندوب</span> </button>
                            @endif
                            <a type="button"
                    ...
                    <div class="col-12 mt-3">
                        <form action="{{ route('users.driver') }}" method="GET">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-lg-9">
                                        <div>
                                            ...
                                            <input name="q" class="form-control" placeholder="ابحث عن سائق / مندوب">
                                        </div>
                                    </div>
                    ...
                    <div
                        ...
                        <div class="table-title-container">
                            <h3 class="table-title">جدول السائقين/المناديب</h3>
                        </div>
    ...
    <!-- add-new-modal modal -->
    <div class="modal fade add-new-driver" tabindex="-1" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">إضـافة سائق/مندوب</h3>
                </div>
                <div class="modal-body">
                    <form action="{{ route('users.driver.store') }}" method="POST">
                        @csrf
