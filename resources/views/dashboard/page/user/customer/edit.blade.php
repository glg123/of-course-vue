                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-5">
                            <div>
                                ...
                                <textarea name="comment" rows="7" class="form-control" type="text" placeholder="اضف تعليق او ما تود ذكره"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-5">
                            <div>
                                ...
                                <input name="address[0][street_name]" class="form-control" type="text" placeholder="اسم الشارع كاملاً">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-5">
                            <div>
                                ...
                                <input name="address[0][gadah]" class="form-control" type="text" placeholder="اسم الجادة">
                            </div>
                        </div>
                        <div class="col-lg-6 mb-5">
                            <div>
                                <label class="form-label">رقم المنزل</label>
                                <input name="address[0][building_no]" class="form-control" type="text" placeholder="رقم المنزل">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-5">
                            <div>
                                ...
                                <input name="address[0][house_no]" class="form-control" type="text" placeholder="رقم الشقة">
                            </div>
                        </div>
                        {{-- <div class="col-lg-6 mb-5">
                            <div>
                        ...
                        <div class="col-lg-12 mb-5">
                            <div>
                                <label class="form-label">اضف تعليق او ما تود ذكره</label>
                                <textarea rows="7" class="form-control" type="text" name="address[0][comment]" placeholder="اضف تعليق او ما تود ذكره"></textarea>
                            </div>
                        </div>
