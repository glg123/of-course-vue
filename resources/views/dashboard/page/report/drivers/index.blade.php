            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-6">
                        <h1 class="page-main-title"> السائقين </h1>
                    </div>
                        ...
                        <form>
                            <div class="form-content container py-3 filter-box">
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-lg-3 text-start mt-3 mt-lg-0">
                                        <button type="button"
                                            class="btn disabled btn-light waves-effect waves-light form-btn px-5"><i
                    ...
                    <div
                        ...
                        <div class="table-title-container">
                            <h3 class="table-title"> تقارير السائقين </h3>
                        </div>
