            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-3">
                        <h1 class="page-main-title"> خطط الأنظمة الغذائية
                        </h1>
                    </div>
                    @if (auth()->user()->can('diet-plan-add'))
                            ...
                            <div class="page-card-btn-groub">
                                <button type="button"
                                    ...
                                    data-bs-toggle="modal" data-bs-target=".add-meal-category-modal"> <i
                                        class="bx bx-plus-circle mx-1"></i> <span>إضــافة خطه</span> </button>
                    ...
                    <div
                        ...
                        <div class="table-title-container">
                            <h3 class="table-title"> جدول خطط الأنظمة </h3>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title"> إضـافة خطة غذائية
                    </h3>
                </div>
                    ...
                    <form action="{{ route('meal.plan.store') }}" method="POST">
                        ...
                        <div class="row align-items-end justify-content-start">
                            ...
                            <div class="col-lg-6 mb-3">
                                <div>
                                    <label class="form-label">اسم خطة ( باللغة العربية )</label>
                            ...
                            <div class="col-lg-6 mb-3">
                                <div>
                                    <label class="form-label">اسم خطة ( باللغة الإنجليزية )</label>
