...
@section('content')
    ...
    <div class="page-content" id="dashboard">
        ...
        <div class="page-card container p-4">
            <h1 class="page-main-title mb-4"> لوحـة التحكــم </h1>
        </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="fw-bold m-0">3.930K</h4>
                                <h5 class="fw-bold m-0 mt-1">عملاء نشطين</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-12 my-3 my-lg-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="fw-bold m-0">280</h4>
                                <h5 class="fw-bold m-0 mt-1">طلبات مبيعات اليوم</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-12 my-3 my-lg-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="fw-bold m-0">275</h4>
                                <h5 class="fw-bold m-0 mt-1">تسليم مبيعات اليوم</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-12 my-3 my-lg-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="fw-bold m-0">$90745</h4>
                                <h5 class="fw-bold m-0 mt-1">مجموع المبيعات</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-evenly mx-2">
            ...
            <div class="col-12 col-lg-5 bg-white my-3 my-lg-0 rounded">
                <h4 class="py-3 border-bottom border-dark mb-2 fw-bold"> إحصائيات العملاء </h3>
                    <div id="chart"></div>
            </div>
            <!-- Chart 2 -->
            <div
                ...
                <div class="w-100">
                    <h4 class="py-3 border-bottom border-dark mb-2 fw-bold">تقرير الطلبات </h3>
                </div>
                <div id="chart2"></div>
                <div class="row align-items-start secondChart">
                    <div class="col-3 dountCharLabel" id="salesLabel1">
                        <h6> <span class="dountCharLabelColor"> </span> اجمالى طلبات المبيعات </h6>
                        <h6>1000</h6>
                    </div>
                    <div class="col-3 dountCharLabel" id="salesLabel2">
                        <h6> <span class="dountCharLabelColor"> </span> طلبات المبيعات </h6>
                        <h6>1500</h6>
                    </div>
                    <div class="col-3 dountCharLabel" id="salesLabel3">
                        <h6> <span class="dountCharLabelColor"> </span> مبيعات اليوم </h6>
                        <h6>500</h6>
                    </div>
                    <div class="col-3 dountCharLabel" id="salesLabel4">
                        <h6> <span class="dountCharLabelColor"></span> المبيعات المخفضة </h6>
                        <h6>1500</h6>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-3 bg-white my-3 rounded">
                <h5 class="py-3 border-bottom border-dark  fw-bold"> الحزم والباقات (حزمة) </h5>
                <div id="chart3"></div>
            </div>
            <!-- Chart 4 -->
            <div class="col-12 col-lg-3 bg-white my-3 rounded">
                <h5 class="py-3 border-bottom border-dark  fw-bold"> التسليم / التوصيل ( تم تسليمه) </h5>
                <div id="chart4"></div>
            </div>
            <!-- Chart 5 -->
            <div class="col-12 col-lg-3 bg-white my-3 rounded">
                <h5 class="py-3 border-bottom border-dark  fw-bold"> الوجبات الشائعة (وجبة)</h5>
                <div id="chart5"></div>
            </div>
            <!-- Birth Days Card -->
            <div class="col-12 col-lg-5 bg-white my-3 rounded">
                <h4 class="py-3 border-bottom border-dark mb-2 fw-bold"> أعيــاد ميلاد العمــلاء</h3>
                    <div class="row">
                        <!-- Item -->
                        <div class="col-12 row justify-content-evenly align-items-center birthday-item py-2">
                            ...
                            <div class="col-4">
                                <span class="bg-success p-2 rounded text-white"> اليوم </span>
                            </div>
                        </div>
                        <!-- Item -->
                        <div class="col-12 row justify-content-evenly align-items-center birthday-item py-2">
                            ...
                            <div class="col-4">
                                <span class="bg-danger p-2 rounded text-white"> غداً </span>
                            </div>
                        </div>
                        <!-- Item -->
                        <div class="col-12 row justify-content-evenly align-items-center birthday-item py-2">
                            ...
                            <div class="col-4">
                                <span class="bg-primary p-2 rounded text-white"> بعد يومين </span>
                            </div>
                        </div>
                    </div>
            </div>
            <!-- specialists Card -->
            <div class="col-12 col-lg-5 bg-white my-3 rounded">
                <h4 class="py-3 border-bottom border-dark mb-2 fw-bold"> أخصائي التغذية </h3>
                    <div class="row">
                        <!-- Item -->
...
=======
                    ...
                    <div class="col-12 row justify-content-start align-items-center special-item py-2">
                        <div class="col-2 mx-2">
                            <img class="img-fluid rounded-circle" src="{{asset('back')}}/assets/images/ofCourse-images/client-profile.png">
                        </div>
                        <div class="col-6">
                            <h6> عبد الرحمن احمد عبدالله </h6>
                            <small> مدرب شخصي</small>
...
>>>>>>> Stashed changes
            ...
            <div class="col-12 col-lg-4 bg-white my-3 rounded">
                <h4 class="py-3 border-bottom border-dark mb-2 fw-bold"> تقييم الوجبات </h3>
                    <div class="row">
                        <!-- Item -->
                ...
                <h4 class="py-3 border-bottom border-dark mb-2 fw-bold"> تقييم الوجبات </h3>
                    <div class="row">
                        ...
                        <div class="col-12 row justify-content-start align-items-center special-item py-2">
                            ...
                            <div class="col-6">
                                <h4 class="m-0"> المادة الغائية </h3>
                            </div>
                            <div class="col-4">
                                <h5 class="m-0"> نسبة المادة الغذائية : 30 %</h5>
                            </div>
                        </div>
                        <!-- Item -->
                        <div class="col-12 row justify-content-start align-items-center special-item py-2">
