            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-3">
                        <h1 class="page-main-title">الإشارة الى الوجبات </h1>
                    </div>

                    <div class="col-12 mt-4 bg-secondary py-3 mx-auto">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="m-0 fw-bold">الإشارة الى الوجبات</h4>
                                {{-- <button type="button"
                            ...
                            <div class="col-12 row tag-items-container">
                                @foreach ($tags as $tag)
                                    <form method="POST" action="{{ route('tags.update', $tag->id) }}"
                                        ...
                                        <div class="col-1">
                                            @if (auth()->user()->can('meal-tag-delete'))
                                        ...
                                        <div class="col-1">
                                            @if (auth()->user()->can('meal-tag-edit'))
